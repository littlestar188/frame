	...
	//var index = {
		...
		*/
		...
		//            }
		    ...
		    $.get("http://192.168.0.15:80/frame/self/json/echartData/echratData2-month-data.json",function (data) {
		    	console.log(data)
		       	for(var i in data){
        ...
        //                    {value:1548, name:'搜索引擎'}
            ...
            $.get("http://192.168.0.15:80/frame/self/json/echartData/echratData2-device-num.json",function (data) {
               for(var i in data){
            ...
            //                    {value:310, name:'不在线'},
                ...
                $.get("http://192.168.0.15:80/frame/self/json/echartData/echratData2-status-data.json",function (data) {
                    console.log(data);
                    for(var i in data){
                        if(i=='online'){
