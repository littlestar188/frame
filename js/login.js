...
$(function () {
  var login = {
    ajaxUrlheader:/*"http://127.0.0.1:8080"*/"http://192.168.0.21:8080",

    localHeader:/*"http://192.168.0.40:80"*/"http://192.168.0.90:80",//本地服务器 必须是localhost
    result:{},
    navData:{},
    name:"",
    password:"",
    ...
    infoCheck:function(){
      ...
      $.ajax({
        url:this.ajaxUrlheader+'/user/login',
