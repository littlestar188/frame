	...
	var instock = Object.create(role);
	var instock = $.extend(instock,{
	//var device = {
		init:function(){
			var that = this;
			...
			// $('#main-footer').load('resources/layout/footer.html',function(){});
		},
			...
			$('#instock_table').bootstrapTable({
			      ...
			      // queryParams : queryParams,
			       ...
			       columns : [
			           ...
			           {field : 'outTime',title : '入库时间',align : 'center',width : 60,valign : 'middle'
			           },
                       {field : 'outTime',title : '入库时间',align : 'center',width : 60,valign : 'middle'
                       },
			           {field : 'id',title : '操作',align : 'center',width : 100,valign : 'middle',
			               formatter : function(value,row) {
			               return instock.optShow(value);}
			           }
			       ]
			   });
