...
var publicFun = {
	...
	ajaxUrlheader:"http://192.168.0.21:8080",
    localHeader:"http://192.168.0.90:80",
    init:function(){
    ...
    */
	loadTopNav:function(){
		var that = this;	 
		var navUrl ='resources/layout/top-nav.html' ;
		//var nav1 ='resources/layout/top-nav.html'
		//var nav2 = 'resources/layout/top-nav.html';
		...
		$('#nav-header').load(navUrl,function(){
			...
			$.ajax({
				...
				//url:'http://192.168.0.21:8080/user/personInfo',
				//type:'post',
				cache:true,
				dataType:"json",
    ...
    */
	loadeFooter:function(){ 
		var footUrl ='resources/layout/footer.html';
		// /var foot1 ='resources/layout/footer.html';
    ...
    */
	navRender:function(){
		...
		$.ajax({
			...
			//stype:"get",
			//url:'http://192.168.0.21:8080/menu/leftTree',
			//type:'post',
			dataType:"json",
			//async : false,
	...
	*/
	...
	toPersonl:function(){
		this.personlBtn.click(function(){
			window.setTimeout(window.location.href="./personal.html",500);
		})
	}
};
